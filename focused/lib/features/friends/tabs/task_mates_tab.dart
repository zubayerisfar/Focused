...
class TaskMatesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 6),
              Text(
                'Create up to 3 task squads to team up with friends, share tasks, and earn bonus EXP together.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontFamily: 'Quicksand',
                  color: isDark
    ...
    return ListView(
      ...
      children: [
        ...
        // 3 Slots (Filled Squads + Empty Add Slots like Best Friends tab)
        for (int i = 0; i < 3; i++)
          if (i < groups.length)
            _buildSquadCard(
              context,
            ...
            _buildEmptySquadSlotTile(
              context,
              slotNumber: i + 1,
              isDark: isDark,
              scheme: scheme,
              canCreate: taskMateProvider.canCreateGroup,
  ...
  Widget _buildEmptySquadSlotTile(
